...
routes.patch('/api/v1/order/:id/price', Order.updateOrderPrice);
routes.patch('/api/v1/car/:id/status', Car.markSold);
routes.patch('/api/v1/car/:id/price', Car.updateCarPrice);
...
routes.get('/', (req, res) => { res.send("Welcome to Auto Mart"); });
